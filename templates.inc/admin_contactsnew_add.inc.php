					...
					<?php foreach($parser["langs"] as $_key_2=>$_var_2)
{
 ?>
					<div class="half-block">
						...
						<input type="text" class="prev" name="address_<?php echo $parser["langs"][$_key_2]["ID"]; ?>" value="" />
					</div>
					<?php 
}
 ?>
					<div class="half-block">
						...
						<input type="text" class="prev" name="regnr" value="" />
					</div>
					<div class="half-block">
						<h1><?php echo (voc('E-mail')); ?>:</h1>
						<input type="text" class="prev" name="email" value="" />
					</div>
					<div class="half-block">
						<h1><?php echo (voc('Phone')); ?>:</h1>
						<input type="text" class="prev" name="phone1" value="" />
					</div>
					<div class="half-block">
						<h1><?php echo (voc('Phone')); ?>:</h1>
						<input type="text" class="prev" name="phone2" value="" />
					</div>
	...
	<?php foreach($parser["langs"] as $_key_4=>$_var_4)
{
 ...
 ?>
	...
	$("#mapinput").bind("geocode:dragged", function(event, latLng){          
		...
		$.getJSON("http://maps.googleapis.com/maps/api/geocode/json?latlng="+latLng.lat()+","+latLng.lng()+"&sensor=true&key=AIzaSyCavW8AoEM_-uUg3bjxrwG98XrbBR_puY0", function(data) {
			var obj = data;
